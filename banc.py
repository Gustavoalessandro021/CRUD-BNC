...
# cursor.execute("INSERT INTO alunos(nome,idade,email)VALUES(1, 'Juan',17,'juanpedro@gmail.com')") 
# cursor.execute("INSERT INTO alunos(nome,idade,email)VALUES(2, 'Arthur',18,'arthurfreitas@gmail.com')") 
# cursor.execute("INSERT INTO alunos(nome,idade,email)VALUES(3, 'Gustavo',19,'gustavosilva@gmail.com')") 
